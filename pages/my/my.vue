<template>
	<view>
		<view class="p-3 flex align-center">
			...
			<view class="flex-1 flex flex-column text-muted font">
				<view class="flex align-end">
					...
					<text class="font-lg text-dark mr-2"> {{ user.sex }}</text>
				</view>
				<text class="text-ellipsis">{{ user.email }}</text>
		...
		<view
			class="position-fixed fixed-bottom mb-5 col-11 m-auto bg-main text-white flex align-center justify-center font-md py-2 rounded-circle"
